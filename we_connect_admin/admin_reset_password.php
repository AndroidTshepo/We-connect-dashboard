       ...
       <table class="table-responsive panel-back noti-box profile_tbl">
        ...
        <table class="table-responsive panel-back noti-box profile_tbl">
         ...
         <h2 class="top_text">Change Admin Password</h2>
            ...
            <tr>
               <td><label for="surname">The new Password: </label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <label style="color:green;"><h1>BVGDVJWUHNWHENN</h1></label> </td>
            </tr>
           
            <tr>
                <td><button class="adminResetPassword btn btn-warning">Reset Password</button></td>
            </tr>
